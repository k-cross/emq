...
class Order:
	...
	def __init__(self, items, totalCost, orderPlacedTime, storeAddress , deliveryAddress,  deliveryEstimateTotalSeconds, deliveryDistanceMeters, deliveryDistanceMiles, speed):
		self.items = items
